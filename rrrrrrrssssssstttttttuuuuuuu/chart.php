      ...
      ?>
           ...
           <div class="box-header with-border">
            ...
            <span class="pull-right">
                          ...
                          <?php
                    $sql = "SELECT id,start_status FROM starttime where id=1";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
                        if ($row['start_status']==0){
                        echo " <a href='#addnew' data-toggle='modal' class='btn btn-success btn-sm btn-flat' data-id='".$row['id']."'><i class='fa fa-edit'></i> Start VOTING</a>";
                        }else{         
                            echo "
                           <a href='#addnew' data-toggle='modal' class='btn btn-danger btn-sm btn-flat' data-id='".$row['id']."'><i class='fa fa-edit'></i> STOP VOTING</a>
                           ";
                  }}
                  ?>
             </div>    
...
<?php
  ...
  while($row = $query->fetch_assoc()){
    ...
    while($crow = $cquery->fetch_assoc()){
      ...
      $sql = "SELECT * FROM votes WHERE status='0' AND candidate_id = '".$crow['id']."'";
