<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="votescount.php"><span class="glyphicon glyphicon-lock"></span> <span>Votes Count</span></a></li>
      ...
      <li class=""><a href="chart.php"><i class="fa fa-black-tie"></i> <span>Vote Chart</span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>